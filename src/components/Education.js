            ...
            <div className="main-container grid">
                ...
                <motion.div initial={{opacity: 0, x: -200}} animate={{opacity: 1, x:0, animationDelay:2}} exit={{opacity: 0, x:100}} transition={{duration: 0.4}}>
                   ...
                   <div className="main-text">
                     <p>Before coming to the UK, I finished High School in Brazil, then I did a IESOL Course at Barnet and Southgate College in order to improve my english skills.</p>
                     <p>Currently I am studying Front-End development. Currently I am following the Frontend careerpath course at codecademy and so far I've been loving it.</p>
